...
2. Open `references/locid-and-component-fields.md` when the task stores localization keys in data.
3. Open `references/entity-name-and-popup-patterns.md` for popup, chat, or entity-name formatting.
4. Keep literal user-facing English out of C#.
